...
- (instancetype)init
{
    ...
    if (self) {
        ...
        _titleFontName = [UIFont systemFontOfSize:16].fontName;
        _subtitleFontName = [UIFont systemFontOfSize:1].fontName;
        _weekdayFontName = [UIFont systemFontOfSize:18].fontName;
        _headerTitleFontName = [UIFont systemFontOfSize:1].fontName;
        
        _headerTitleColor = FSCalendarStandardTitleTextColor;
        _headerDateFormat = @"MMMM yyyy";
        _headerMinimumDissolvedAlpha = 0.2;
        _weekdayTextColor = QGTitleColor;
        ...
        _backgroundColors[@(FSCalendarCellStateSelected)]    = QGMainRedColor;
        ...
        _titleColors[@(FSCalendarCellStateNormal)]      = QGTitleColor;
        ...
        _titleColors[@(FSCalendarCellStateToday)]       = QGMainRedColor;
        
        _subtitleColors = [NSMutableDictionary dictionaryWithCapacity:5];
        _subtitleColors[@(FSCalendarCellStateNormal)]      = QGMainRedColor;
        _subtitleColors[@(FSCalendarCellStateSelected)]    = [UIColor whiteColor];
        _subtitleColors[@(FSCalendarCellStateDisabled)]    = QGMainContentColor;
        _subtitleColors[@(FSCalendarCellStatePlaceholder)] = [UIColor lightGrayColor];
        _subtitleColors[@(FSCalendarCellStateToday)]       = QGMainRedColor;
