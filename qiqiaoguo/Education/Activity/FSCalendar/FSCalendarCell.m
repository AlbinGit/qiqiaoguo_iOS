...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
//        self.contentView.backgroundColor = QGRandomColor;
...
//        if (_subtitle) {
            ...
            _titleLabel.frame = CGRectMake(
                                           ...
                                           (self.contentView.fs_height*5.0/6.0-height)*0.5+self.preferredTitleOffset.y + 0,
                                           self.fs_width,
                                           titleHeight
                                          );
...
- (UIColor *)colorForTitleLabel
{
    ...
    UIColor *co = self.preferredTitleDefaultColor ?: [self colorForCurrentStateInDictionary:_appearance.titleColors];
    
    return _canSelect ? co : QGlineBackgroundColor;
}
