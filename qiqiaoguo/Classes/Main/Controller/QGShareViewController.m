...
@interface QGShareViewController ()

@end

@implementation QGShareViewController
...
- (instancetype)init {
    ...
    if (self) {
        ...
        _qqButton.enabled = [QGSocialService isSupportQQ];
        _qZoneButton.enabled = [QGSocialService isSupportQQ];
        _sinaButton.enabled = [QGSocialService isSupportSina];
...
- (void)viewDidLoad {
    ...
    [self.view addSubview:_cancelButton];
     [_shareContainer layoutIfNeeded];
