//
//  QGNewDouYinController.m
//  qiqiaoguo
//
//  Created by 史志杰 on 2020/6/20.
//

#import "QGNewDouYinController.h"
...
@interface QGNewDouYinController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation QGNewDouYinController
...
- (UIButton *)backBtn {
    if (!_backBtn) {
        ...
        [_backBtn setImage:[UIImage imageNamed:@"nav-back-icon"] forState:UIControlStateNormal];
