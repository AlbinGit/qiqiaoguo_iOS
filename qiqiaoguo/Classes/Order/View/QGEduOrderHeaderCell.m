...
@interface QGEduOrderHeaderCell ()
...
@end
@implementation QGEduOrderHeaderCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style
    ...
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        _logisticsDetailLabel.text = @"报名情况:";
...
- (void)layoutSubviews {
    ...
    _separated2View.X = 0;
    _separated2View.Y = lastView.maxY + 12;
...
- (void)configLogisticsInfo{
    ...
    for (QGMallGoodsModell *model in self.order.goods) {
        ...
        peopleLabel.text = [NSString stringWithFormat:@"¥%.2f",model.goodsPrice];
