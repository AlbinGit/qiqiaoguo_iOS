...
@interface QGEducatiionOrderViewController () <VTMagicViewDataSource,VTMagicViewDelegate>
...
@implementation QGEducatiionOrderViewController
...
- (UIViewController *)magicView:(VTMagicView *)magicView viewControllerAtPage:(NSUInteger)pageIndex
{
    if (pageIndex == 0) {
        ...
        QGEducationOrderListViewController *viewController = [magicView dequeueReusablePageWithIdentifier:gridId];
        if (!viewController) {
            viewController = [[QGEducationOrderListViewController alloc] init];
