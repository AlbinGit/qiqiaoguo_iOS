...
@implementation SZJBrowserImageView

{
//    __weak CNWaitingView *_waitingView;
    BOOL _didCheckSize;
...
{
//    CNWaitingView *waiting = [[CNWaitingView alloc] init];
//    waiting.bounds = CGRectMake(0, 0, 60, 60);
//    waiting.mode = CNWaitingViewProgressMode;
//    _waitingView = waiting;
//    [self addSubview:waiting];


    __weak SZJBrowserImageView *imageViewWeak = self;
...
- (void)prepareForImageViewScaling
{
    if (!_zoomingScroolView) {
        ...
        _zoomingScroolView.backgroundColor = [UIColor blackColor];
