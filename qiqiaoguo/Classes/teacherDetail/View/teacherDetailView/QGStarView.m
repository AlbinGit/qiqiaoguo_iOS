...
#import "QGStarView.h"
#define WHITE_NAME @"ic_默认星星"
#define RED_NAME @"ic_点亮星星"

@interface QGStarView ()

@property(nonatomic,assign)QGStarType      starType;
...
@implementation QGStarView

- (instancetype)initWithFrame:(CGRect)frame starSize:(CGSize)starSize withStyle:(QGStarType)style
{
...
- (void)initView
{
    ...
    if (self.starType == QGStarTypeInteger)
    {
        for (int i = 0; i < 5; i++)
        {
