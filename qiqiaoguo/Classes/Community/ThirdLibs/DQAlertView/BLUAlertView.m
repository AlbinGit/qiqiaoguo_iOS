...
#define DEFAULT_ALERT_WIDTH 300
#define DEFAULT_ALERT_HEIGHT 144

@interface BLUAlertView ()
{
...
// Init method
- (instancetype)initWithTitle:(NSString *)title message:(NSString *)message delegate:(id /*<BLUAlertViewDelegate>*/)delegate cancelButtonTitle:(NSString *)cancelButtonTitle otherButtonTitles:(NSString *)otherButtonTitles, ...
{
...
- (instancetype)initWithTitle:(NSString *)title message:(NSString *)message cancelButtonTitle:(NSString *)cancelButtonTitle otherButtonTitle:(NSString *)otherButtonTitle
{
    ...
    if (self) {
        ...
        self.appearAnimationType = BLUAlertViewAnimationTypeDefault;
        self.disappearAnimationType = BLUAlertViewAnimationTypeDefault;
        self.cornerRadius = 8;
        ...
        // Bw
        self.titleTopPadding = 0.0;
        self.titleHeight = 64.0;
        self.titleBottomPadding = 16.0;
        self.messageBottomPadding = 88.0;
        self.messageLeftRightPadding = 16.0;
...
- (void) addThisViewToView: (UIView *) view
{
    ...
    if (self.appearAnimationType == BLUAlertViewAnimationTypeDefault)
    {
    ...
    else if (self.appearAnimationType == BLUAlertViewAnimationTypeZoomIn)
    {
    ...
    else if (self.appearAnimationType == BLUAlertViewAnimationTypeFadeIn)
    {
        self.alpha = 0;
        [UIView animateWithDuration:timeAppear delay:timeDelay options:UIViewAnimationOptionCurveEaseOut animations:^{
            self.alpha = 1;
    ...
    else if (self.appearAnimationType == BLUAlertViewAnimationTypeFlyTop)
    {
    ...
    else if (self.appearAnimationType == BLUAlertViewAnimationTypeFlyBottom)
    {
        CGRect tmpFrame = self.frame;
    ...
    else if (self.appearAnimationType == BLUAlertViewAnimationTypeFlyLeft)
    {
        CGRect tmpFrame = self.frame;
    ...
    else if (self.appearAnimationType == BLUAlertViewAnimationTypeFlyRight)
    {
        CGRect tmpFrame = self.frame;
    ...
    else if (self.appearAnimationType == BLUAlertViewAnimationTypeNone)
    {
        [self didAppearAlertView];
    }
}
...
- (void)dismiss
{
    ...
    if (self.disappearAnimationType == BLUAlertViewAnimationTypeDefault) {
        self.transform = CGAffineTransformIdentity;
    ...
    else if (self.disappearAnimationType == BLUAlertViewAnimationTypeZoomOut )
    {
        self.transform = CGAffineTransformIdentity;
        [UIView animateWithDuration:timeDisappear delay:timeDelay options:UIViewAnimationOptionCurveEaseOut animations:^{
            self.transform = CGAffineTransformMakeScale(0.01, 0.01);
    ...
    else if (self.disappearAnimationType == BLUAlertViewAnimationTypeFaceOut)
    {
        self.alpha = 1;
        [UIView animateWithDuration:timeDisappear delay:timeDelay options:UIViewAnimationOptionCurveEaseOut animations:^{
            self.alpha = 0;
    ...
    else if (self.disappearAnimationType == BLUAlertViewAnimationTypeFlyTop)
    {
        [UIView animateWithDuration:timeDisappear delay:timeDelay options:UIViewAnimationOptionCurveEaseOut animations:^{
            self.frame = CGRectMake(self.frame.origin.x, - self.frame.size.height - 10, self.frame.size.width, self.frame.size.height);
    ...
    else if (self.disappearAnimationType == BLUAlertViewAnimationTypeFlyBottom)
    {
        [UIView animateWithDuration:timeDisappear delay:timeDelay options:UIViewAnimationOptionCurveEaseOut animations:^{
    ...
    else if (self.disappearAnimationType == BLUAlertViewAnimationTypeFlyLeft)
    {
        [UIView animateWithDuration:timeDisappear delay:timeDelay options:UIViewAnimationOptionCurveEaseOut animations:^{
            self.frame = CGRectMake( - self.frame.size.width - 10, self.frame.origin.y, self.frame.size.width, self.frame.size.height);
    ...
    else if (self.disappearAnimationType == BLUAlertViewAnimationTypeFlyRight)
    {
        [UIView animateWithDuration:timeDisappear delay:timeDelay options:UIViewAnimationOptionCurveEaseOut animations:^{
    ...
    else if (self.disappearAnimationType == BLUAlertViewAnimationTypeNone)
    {
        [self removeFromSuperview];
    }
...
- (void)calculateFrame
{
    ...
    CGFloat buttonBottomPadding = 24.0;
    CGFloat buttonOneHorizonPadding = 40.0;
    CGFloat buttonsHorizonPadding = 20.0;
    CGFloat cancelButtonY = self.height - self.buttonHeight - buttonBottomPadding;
    CGFloat otherButtonY = cancelButtonY;
    ...
    if ( ! self.cancelButtonTitle ) {
        ...
        CGFloat cancelButtonWidth = self.width - buttonOneHorizonPadding * 2;
        CGFloat cancelButtonX = buttonOneHorizonPadding;

        cancelButtonFrame = CGRectMake(cancelButtonX,
                                       cancelButtonY,
                                       cancelButtonWidth,
                                       self.buttonHeight);
    } else if ( ! self.cancelButtonPositionRight ) {

        CGFloat cancelButtonWidth = (self.width - buttonsHorizonPadding * 3) / 2;
        CGFloat cancelButtonX = buttonsHorizonPadding;
        ...
        CGFloat cancelButtonWidth = (self.width - buttonsHorizonPadding * 3) / 2;
        CGFloat cancelButtonX = cancelButtonWidth + buttonsHorizonPadding * 2;
    ...
    if ( ! self.otherButtonTitle ) {
        ...
        CGFloat otherButtonWidth = self.width - buttonOneHorizonPadding * 2;
        CGFloat otherButtonX = buttonOneHorizonPadding;

        otherButtonFrame = CGRectMake(otherButtonX,
                                      otherButtonY,
                                      otherButtonWidth,
                                      self.buttonHeight);
    } else if ( ! self.cancelButtonPositionRight ) {

        CGFloat otherButtonWidth = (self.width - buttonsHorizonPadding * 3) / 2;
        CGFloat otherButtonX = otherButtonWidth + buttonsHorizonPadding * 2;
        ...
        CGFloat otherButtonWidth = (self.width - buttonsHorizonPadding * 3) / 2;
        CGFloat otherButtonX = buttonsHorizonPadding;
...
//    [self.otherButton addTarget:self action:@selector(otherButtonTouchEnded:) forControlEvents:UIControlEventTouchDragOutside];
    ...
    imageView.image = [UIImage imageNamed:@"common-alert-view-header"];
    ...
    self.titleLabel.font = BLUThemeMainFontWithType(BLUUIThemeFontSizeTypeVeryLarge);
    self.messageLabel.font = BLUThemeMainFontWithType(BLUUIThemeFontSizeTypeLarge);
    self.messageLabel.textColor = [UIColor colorWithHue:0.5 saturation:0.01 brightness:0.56 alpha:1];
    self.messageLabel.textAlignment = NSTextAlignmentLeft;

    self.cancelButton.cornerRadius = BLUThemeHighActivityCornerRadius;
    self.cancelButton.backgroundColor = BLUThemeMainColor;
    self.cancelButton.titleColor = [UIColor whiteColor];
    self.cancelButton.borderColor = [UIColor clearColor];
    self.cancelButton.titleFont = BLUThemeMainFontWithType(BLUUIThemeFontSizeTypeLarge);

    self.otherButton.cornerRadius = BLUThemeHighActivityCornerRadius;
    self.otherButton.backgroundColor = [UIColor whiteColor];
    self.otherButton.titleColor = BLUThemeMainColor;
    self.otherButton.borderColor = BLUThemeMainColor;
    self.otherButton.borderWidth = 1.0;
